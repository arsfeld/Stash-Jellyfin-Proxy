...
from stash_jellyfin_proxy.endpoints.stubs import (
    ...
    endpoint_media_folders, endpoint_livetv_channels,
...
from stash_jellyfin_proxy.endpoints.playlists import (
    endpoint_create_playlist,
    endpoint_delete_playlist,
    endpoint_get_playlist,
    endpoint_playlist_add_items,
    endpoint_playlist_items,
    endpoint_playlist_move_item,
    endpoint_playlist_remove_items,
    endpoint_playlist_user,
    endpoint_playlist_user_remove,
    endpoint_playlist_user_update,
    endpoint_playlist_users,
    endpoint_update_playlist,
)
...
routes = [
    ...
    Route("/Users/{user_id}/PlayedItems/{item_id}", endpoint_user_unplayed_items, methods=["DELETE"]),
    ...
    Route("/UserPlayedItems/{item_id}", endpoint_user_played_items, methods=["POST"]),
    Route("/UserPlayedItems/{item_id}", endpoint_user_unplayed_items, methods=["DELETE"]),
    Route("/Library/VirtualFolders", endpoint_virtual_folders),
    Route("/Library/MediaFolders", endpoint_media_folders),
    Route("/LiveTv/Channels", endpoint_livetv_channels),
    Route("/Playlists", endpoint_create_playlist, methods=["POST"]),
    Route("/Playlists/", endpoint_create_playlist, methods=["POST"]),
    Route("/Playlists/{playlist_id}", endpoint_get_playlist, methods=["GET"]),
    Route("/Playlists/{playlist_id}", endpoint_update_playlist, methods=["POST"]),
    Route("/Playlists/{playlist_id}/Items", endpoint_playlist_items, methods=["GET"]),
    Route("/Playlists/{playlist_id}/Items/", endpoint_playlist_items, methods=["GET"]),
    Route("/Playlists/{playlist_id}/Items", endpoint_playlist_add_items, methods=["POST"]),
    Route("/Playlists/{playlist_id}/Items/", endpoint_playlist_add_items, methods=["POST"]),
    Route("/Playlists/{playlist_id}/Items", endpoint_playlist_remove_items, methods=["DELETE"]),
    Route("/Playlists/{playlist_id}/Items/", endpoint_playlist_remove_items, methods=["DELETE"]),
    Route("/Playlists/{playlist_id}/Items/{item_id}/Move/{new_index}", endpoint_playlist_move_item, methods=["POST"]),
    Route("/Playlists/{playlist_id}/Users", endpoint_playlist_users, methods=["GET"]),
    Route("/Playlists/{playlist_id}/Users/{user_id}", endpoint_playlist_user, methods=["GET"]),
    Route("/Playlists/{playlist_id}/Users/{user_id}", endpoint_playlist_user_update, methods=["POST"]),
    Route("/Playlists/{playlist_id}/Users/{user_id}", endpoint_playlist_user_remove, methods=["DELETE"]),
    Route("/Items/{item_id}", endpoint_delete_playlist, methods=["DELETE"]),
