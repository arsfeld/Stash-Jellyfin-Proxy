...
from proxy.stash.query_helpers import (
    get_stash_sort_params,
    scene_filter_clause_for_parent as _scene_filter_clause_for_parent,
)
from proxy.endpoints.users import parse_emby_auth_header
from proxy.util.ids import extract_numeric_id, get_numeric_id, make_guid
        ...
        if not has_movie_type:
            ...
            if is_banner_request:
                ...
                if BANNER_MODE == "tag" and tag_ids:
                    ...
                    res = stash_query(q, {"tids": tag_ids, "per_page": runtime.BANNER_POOL_SIZE})
                    ...
                    res = stash_query(q, {"per_page": runtime.BANNER_POOL_SIZE})
                    pool = res.get("data", {}).get("findScenes", {}).get("scenes", [])
            ...
            if filter_favorites and runtime.FAVORITE_TAG:
                ...
                fav_tag_id = _get_or_create_tag(runtime.FAVORITE_TAG)
                if fav_tag_id:
