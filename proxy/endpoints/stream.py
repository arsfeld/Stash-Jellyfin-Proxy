...
from proxy.stash.client import fetch_from_stash, get_stash_session, stash_query
...
async def endpoint_stream(request):
    ...
    try:
        ...
        # clients rely on this to advance seek position. For plain 200
        # responses, omit Content-Length and let chunked transfer handle it.
